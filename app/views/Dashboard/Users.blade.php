			...
			<section class="dash-padding">
				<table class="table table-striped table-centered table-responsive">
			    	...
			    	<tbody data-bind="foreach: sourceItems">
						<tr>
							<td class="col-sm-1"><img class="img-responsive col-sm-12" data-bind="attr: { src: avatar ? avatar.indexOf('//') > -1 ? avatar : vars.urls.baseUrl+'/'+avatar : vars.urls.baseUrl+'/assets/images/no_user_icon_big.jpg', alt: username }"></td>
