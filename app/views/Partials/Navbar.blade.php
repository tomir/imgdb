	...
	<div class="container">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="{{ url(Str::slug(trans('main.games'))) }}">{{ trans('main.games-menu') }}</a></li>
				<li><a href="{{ url(Str::slug(trans('main.trailers'))) }}">{{ trans('main.trailers-menu') }}</a></li>
				<li><a href="{{ url(Str::slug(trans('main.box'))) }}">{{ trans('main.box-menu') }}</a></li>
				<li><a href="{{ url(Str::slug(trans('main.awards'))) }}">{{ trans('main.awards-menu') }}</a></li>
				<li><a href="{{ url(Str::slug(trans('main.news'))) }}">{{ trans('main.news-menu') }}</a></li>
				<li><a href="{{ url(Str::slug(trans('main.community'))) }}">{{ trans('main.community-menu') }}</a></li>
				<li><a href="{{ url(Str::slug(trans('main.vod'))) }}">{{ trans('main.vod-menu') }}</a></li>
